...
class Bot(object):
    ...
    def __init__(self):
        ...
        self.oauth = {"client_id": "313432735298.334736573248", #os.environ.get("CLIENT_ID"),
                      "client_secret": "95571690aabf5f43e33255ec6ac1fe91", # os.environ.get("CLIENT_SECRET"),
                      # Scopes provide and limit permissions to what our app
                      # can access. It's important to use the most restricted
                      # scope that your app will need.
                      "scope": "bot"}
        self.verification = "TvaSMNNfbQciUR4SrxkMB7rx" #os.environ.get("VERIFICATION_TOKEN")
